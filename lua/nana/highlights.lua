...
return function(palette)
  return {
    ...
    Conceal = { fg = palette.base1 },
    CurSearch = { bg = palette.basehighlight },
    CursorColumn = { bg = palette.base1 },
    CursorLine = { bg = nil },
    CursorLineNr = { fg = palette.base7, bg = nil },
    ...
    LineNr = { fg = palette.base5, bg = nil },
    Macro = { fg = palette.crimson },
    MatchParen = { bg = palette.basehighlight },
    NonText = { fg = palette.base4, bg = palette.base1 },
    Normal = { fg = palette.white, bg = nil },
    NormalFloat = { bg = nil },
    NormalNC = { fg = palette.base7, bg = nil },
    ...
    SignColumn = { fg = palette.white, bg = palette.base1 },
    ...
    TelescopeNormal = { fg = palette.base7, bg = nil },
